...
# Concatena todos os dados coletados em um único DataFrame, se houver dados válidos
if todos_dados:
    df_resultado = pd.concat(todos_dados)
else:
    df_resultado = pd.DataFrame()

# Exibe o DataFrame com os dados, se não estiver vazio
if not df_resultado.empty:
    st.write("Dados das Ações", df_resultado.tail())
else:
    st.write("Nenhum dado encontrado para os ativos selecionados.")

# Verifica se a coluna 'Adj Close' existe antes de acessar
if 'Adj Close' in df_resultado.columns:
